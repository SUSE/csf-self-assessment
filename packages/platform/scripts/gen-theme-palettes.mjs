...
// The SEAL ramp's hue. Derived from the palette's own `--primary` rather
// than authored, so the ordinal ramp and the palette can never disagree
...
function block(selector, vars, hue) {
  ...
  if (hue) {
    lines.push(`  --seal-hue: ${hue}; /* drives the whole SEAL ramp */`);
