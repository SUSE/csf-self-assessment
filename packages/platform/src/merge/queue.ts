...
// The clash queue's narrowing: pure predicates over a landing's
...
// There is deliberately NO bulk apply here: every clash is
...
// BULK APPLY. It existed, constrained to one narrowed class, and
