// Lens tinting for gesture provenance — one
...
// Pure presentation, mapped theme utilities only. Description made
// visible, never judgment — the engine scored these identically.
// How a gesture placed an answer. One vocabulary for every medium.
