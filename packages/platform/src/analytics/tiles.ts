...
//
// The dashboard is statistics: scoring, answer breakdowns, provenance.
// Vendor recommendations left it for their own page — a marketing
// surface has nothing to gain from a six-column module and nothing to
// say about the numbers beside it.
export type TileId =
  | 'floor'
  | 'score'
  | 'objectives'
...
type TileBase = {
  ...
  // cannot render at tile size. Default `true`.
  //
