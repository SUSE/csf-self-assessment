...
// recommender , so an unattributed offer is unrepresentable past
...
// Spine item 8. Adds nothing to `recommendationsPage()` but
...
// the section is ABSENT, not empty and not explained.
