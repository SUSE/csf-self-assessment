<script lang="ts">
  ...
  // One objective's clashes: a header that states the group's size
  // and its decided count, plus the collapse toggle.
  // Presentational — every number arrives already computed .
  ...
  // reads and there is no arithmetic here to disagree with the core .
