<script lang="ts">
  ...
  // One question's fan-out as a wheel. ANGLE is the target unit, RADIUS
  ...
  // with no evidence diamond = placed but undefended.
  ...
  // truth — `bindingPotential` is this question's own minimum, NOT
