...
import type { CandidateTrust, DesktopSystem } from './contract.js';

export const BUILDER_SIGNING_VARIABLE_NAMES: readonly string[] = [
  'CSC_LINK',
  'CSC_KEY_PASSWORD',
  'CSC_NAME',
...
export type SigningEnvironmentInput = {
...
export async function withSigningEnvironment<T>(
  input: SigningEnvironmentInput,
