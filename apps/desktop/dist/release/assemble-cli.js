...
import { CommitShaSchema, readRootReleaseVersion, requireReleaseTagForVersion, } from './contract.js';
...
const USAGE = 'Usage: assemble-cli.ts <input-directory> <output-directory> <tag> <commit-sha> <node-version>\n';
async function main() {
    ...
    const [inputDirectory, outputDirectory, suppliedTag, commitValue, nodeVersion] = parsed.data;
