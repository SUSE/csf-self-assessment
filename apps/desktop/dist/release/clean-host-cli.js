...
import { CandidateTrustSchema, CleanHostLaneSchema, PACKAGE_TRUST_VARIABLE, } from './contract.js';
import { planCleanHostTest, prepareCleanHostCandidate, } from './clean-host.js';
import { createNativeJobLog, createPnpmCommandRunner, } from './native-job.js';
const UsageSchema = z.tuple([
    CleanHostLaneSchema,
    CandidateTrustSchema,
    z.string().min(1),
]);
const USAGE = 'Usage: clean-host-cli.ts <macos-arm64|macos-x64|windows-x64|linux-x64> <unsigned-candidate|signed-candidate> <candidate-directory>\n';
async function main() {
