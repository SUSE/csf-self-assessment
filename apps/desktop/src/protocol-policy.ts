...
export type RendererRequestDecision =
  | { kind: 'serve'; html: Uint8Array }
  | { kind: 'refuse' };

export function decideRendererRequest(
  target: DesktopTarget,
  requestUrl: URL,
  rendererHtml: Uint8Array,
...
export function rendererResponse(decision: RendererRequestDecision): Response {
